                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="product_name"
                                    title="يرجي ادخال اسم المنتج" value="{{ $products->product_name }}" required>
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">سعر المنتج</label>
                                <input type="text" class="form-control" id="inputName" name="price"
                                    title="يرجي ادخال سعر المنتج" value="{{ $products->price }}" required>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                ...
                                <select name="varietie_id" class="form-control SlectBox">
                                    ...
                                    @foreach ($varieties as $varietie)
                                        <option value="{{ $varietie->id }}"
                                            @if ( $varietie->id == $products ->varietie_id)
                                            selected
                                        @endif> {{ $varietie->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="suppliers[]" class="form-control SlectBox" multiple>
                                    ...
                                    @foreach ($suppliers as $supplier)
                                        <option
                                            value="{{$supplier->id }}" 
                                            @if(in_array($supplier->id,$products->suppliers->pluck('id')->toArray())) selected @endif>
