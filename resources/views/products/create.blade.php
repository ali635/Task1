                    ...
                    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="varietie_id" class="form-control SlectBox">
                                    <!--placeholder-->
                                    <option value="" selected disabled>حدد القسم</option>
                                    @foreach ($varieties as $varietie)
                                        <option value="{{ $varietie->id }}"> {{ $varietie->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">المورد</label>
                                <select name="suppliers[]" class="form-control SlectBox" multiple>
                                    <!--placeholder-->
