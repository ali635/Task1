            ...
            <div class="card mg-b-20">
                    ...
                    <div class="card-header pb-0">
                        <div class="col-md-6">
                            <a href="products/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp; اضافة منتج
                            </a>
                        </div>
                        <br>
                        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example4" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            <thead>
                                <tr>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href=" {{ route('products.edit',$product->id) }}">تعديل
                                                            الفاتورة</a>
                                                 

                                                   
                                                        <a class="dropdown-item" href="#" data-invoice_id="{{ $product->id }}"
